# 🎨 Compose Practice Hub: 1 Screen Per Day Challenge
...
### Why follow this hub?
- **Real-World Scenarios**: No more "Foo/Bar" examples. We build dashboards, wallets, and social feeds.
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/thogaruchesti-hemanth/compose-practice-hub.git
   cd compose-practice-hub
   ```

2. **Switch to a specific UI branch**
   ```bash
   git checkout feat/day-1-crypto-dashboard
   ```
...
| Day 1: Crypto Dashboard | Preview | Preview |
|:---:|:---:|:---:|
| <a href="https://github.com/user-attachments/assets/1204c907-9907-4a27-abf5-673e21fbb9a9"><img src="https://github.com/user-attachments/assets/c8ed823c-1a0d-40e5-8cc0-3253b58b49cf" width="180" height="380"/></a> | | |
| `feat/day-1-crypto-dashboard` | | |
| ⭐⭐⭐ Intermediate | | |

### 🌱 Practice

| Text Practice | Column Arrangements | Row Column Practice | Codelab Practice |
|:---:|:---:|:---:|:---:|
...
- **State Management**: Flow, ViewModel, Compose State
- **Animations**: Animatable, Transition API, AnimatedVisibility
- **Navigation**: Compose Navigation

## 🤝 Contributing
We welcome contributions! Please follow the **One UI per Branch** principle to keep the learning experience clean.
